...
const App = () => {
  ...
  let [profilePicture, setProfilePicture] = useState(
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmsSvEY1mmpXAuHIuVwPUsHQJ6DdzgP3tyJw&usqp=CAU',
  );
  ...
  const completeRegistration = () => {
    if (
      ...
      reference.once('value').then(snapshot => {
        ...
        const reference = storage().ref('/Users/profilePictures');
        async () => {
          ...
          await reference
            .putFile(pathToFile)
            .then(console.log('uploaded'), console.log('rejected'));
        };
